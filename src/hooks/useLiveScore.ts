...
// Shared by usePostureRealtime and useHydrationRealtime — both read a
// score + connecting/live/disconnected status from a Realtime subscription
// on their respective table, filtered by session_id. See
// lib/supabase/realtime.ts for the actual subscription logic.
